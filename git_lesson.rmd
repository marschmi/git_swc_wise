...
In this moment you are reminded of a time when you attended a Software Carpentry Workshop in January 2016.  It was a busy time doing the workshop and getting ready for the semester.  However, there was one thing you remember that you learned **version control is better than mailing files back and forth.**
...
> Go to the original Software Carpentry lesson on **automated version control**: <a href="http://swcarpentry.github.io/git-novice/01-basics.html" target="_blank">http://swcarpentry.github.io/git-novice/01-basics.html</a>  


# Remembering Bash and the Unix Shell
...
> Now, let's set up Git by going to <a href="http://swcarpentry.github.io/git-novice/02-setup.html" target="_blank">http://swcarpentry.github.io/git-novice/02-setup.html</a>
...
> 1. In bash, navigate to **`Desktop -> SWC -> SWC_R`** folder from yesterday afternoon's R lesson.  
> 2. In the **`SWC_R`** folder, type `ls -a`.  the `-a` flag shows us the hidden items within the directory.  
> 3. What files you see?
> 4. Now, **initialize the repository** by typing `git init`.  
> 5. What files you see that **`SWC_R`** is now a repository under version control?  
...
> Let's look at `variables.R` by typing `cat variables.R` into the bash shell.  What happens?  What command does this remind your of?  
> `git status`
...
> 1. Log in to GitHub.  
> 2. Click on the icon in the top right corner to create a new repository called `SWC_R`:  
